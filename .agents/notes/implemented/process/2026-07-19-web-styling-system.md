...
> Visual-baseline update (2026-08-14): decision 1's Chat alignment was superseded by the [project-owned island visual language](2026-08-14-island-web-visual-language.md). The CSS Modules, token ownership, and theme-selector constraints remain in force.
